...
public class TradeAcctWithdrawal {
    ...
    public static final String CREATE_WITHDRAWAL_TABLE = "CREATE TABLE IF NOT EXISTS " + WITHDRAWAL_TABLE + " (" + WITHDRAWAL_ID + " INTEGER, " + TRADE_ACCT_PROFILEID + " INTEGER , " +
            ...
            TRADE_ACCT_USERNAME + " TEXT , " + TRADE_ACCT_PASSWORD + " TEXT , " + TRADE_INITIAL_AMOUNT + " REAL, " + TRADE_ACCT_W_BALANCE + " REAL, "+ TRADE_INVESTOR_PERCENTAGE + " TEXT, " + TRADE_TRADER_PERCENTAGE + " TEXT, " + TRADE_COMPANY_PERCENTAGE + " TEXT, " + TRADE_ACCT_START_DATE + " TEXT, " + TRADE_ACCT_END_DATE + " TEXT, " + TRADE_ACCT_STATUS + " TEXT, " + "FOREIGN KEY(" + TRADE_ACCT_PROFILEID + ") REFERENCES " + PROFILES_TABLE + "(" + PROFILE_ID + "),"+
